...
<p align="center">面向 macOS、Windows 和 Linux 的磁盘清理、空间分析与隐私保护工具</p>
...
- Windows：Visual Studio 2022 Build Tools，并安装“使用 C++ 的桌面开发”，以及 Microsoft Edge WebView2 Runtime
- Linux：WebKitGTK 4.1 等 Tauri 2 系统依赖
